...
AT被认为是一种规则的方法，但它不像worddrop那样引入随机的噪声，AT生成的扰动是容易被模型错误分类的例子的变形。
